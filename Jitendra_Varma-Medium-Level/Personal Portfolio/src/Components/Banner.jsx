...
export const Banner=()=>{
    ...
    const toRotate=["MERN Stack Developer","Java Developer","Full Stack Developer","Web Developer"];
            ...
            <Container>
                <Row className={`align-items-center banner-row ${animationDirection}`}>
                    <Col xs={12} md={6} xl={7}>
                        ...
                        <p>Salutations! I'm a committed MERN Stack Developer and Java Developer that has a passion for creating creative solutions and a knack for Java with DSA.      {" "}Currently, I am studying IT in the 6th semester at L.D. College of Engineering,Ahmedabad.</p>
